...
/*public class ImageProcessing{
    public static void main(String []args) throws FileNotFoundException, UnsupportedFileFormatException, IOException {    
        File file;
        file = new File ("/home/dkefalas/NetBeansProjects/HW2/ppm-photos/stack.ppm");
        file.createNewFile();
        //PPMImage image = new PPMImage (file);
        
        File dir = new File("/home/dkefalas/Desktop/stacking-images/M83");
        PPMImageStacker stackImage = new PPMImageStacker (dir);
        
        stackImage.stack();
        stackImage.getStackedImage().toFile(file);
        //image.grayscale ();
